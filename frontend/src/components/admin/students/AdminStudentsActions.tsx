...
import { RemoveStudentForm } from "../../students/forms/RemoveStudentForm";
import { AdminEditStudentForm } from "./forms/AdminEditStudentForm";

interface AdminStudentsActionsProps {
	student: Student;
}

export function AdminStudentsActions({ student }: AdminStudentsActionsProps) {
