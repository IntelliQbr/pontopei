...
import { AdminEditSchoolForm } from "./forms/AdminEditSchoolForm";
import { AdminRemoveSchoolForm } from "./forms/AdminRemoveSchoolForm";
import { AdminViewSchoolForm } from "./forms/AdminViewSchoolForm";

interface AdminSchoolActionsProps {
	school: School;
}

export function AdminSchoolActions({ school }: AdminSchoolActionsProps) {
